    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          ...
          <br />
          de la Economía del Dato Europea
        </motion.h1>
        ...
        >
          Únase a la federación GAIA-X. Obtenga{' '}
          <span className="text-emerald-400 font-bold">30.000€</span> de financiación inicial
          y genere ingresos recurrentes liderando la soberanía digital de su sector.
        </motion.p>
