...
import { 
  Building2, Shield, Users, Settings, Globe, Network, 
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Gobernanza <span className="text-violet-400">Dual</span>
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Control total sobre su territorio + Interoperabilidad con la federación europea
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="intra">
              ...
              >
                <Card className="bg-gradient-to-br from-blue-950/50 to-slate-900 border-blue-500/30 overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-1 space-y-6">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-slate-400">Control Absoluto</span>
                        </div>

                        <h3 className="text-2xl font-bold text-white">
                          Usted Controla su Nodo
                        </h3>

                        <div className="space-y-4">
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            <Coins className="w-6 h-6 text-blue-400 mt-1" />
                            <div>
                              <p className="text-white font-medium">Define Precios</p>
                              <p className="text-slate-400 text-sm">Establezca sus propias tarifas de acceso a datos</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">Valida Miembros</p>
                              <p className="text-slate-400 text-sm">Apruebe o rechace solicitudes de adhesión</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">Controla Accesos</p>
                              <p className="text-slate-400 text-sm">Gestione permisos granulares por dataset</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <TabsContent value="inter">
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Card className="bg-gradient-to-br from-violet-950/50 to-slate-900 border-violet-500/30 overflow-hidden">
                  <CardContent className="p-8">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      {/* Visual Network */}
                      ...
                      <div className="flex-1 space-y-6">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-slate-400">Tecnología Compartida</span>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">Interoperabilidad GAIA-X</p>
                              <p className="text-slate-400 text-sm">Conecte con cualquier nodo certificado en la UE</p>
                            </div>
                          </div>
                          
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            <FileCheck className="w-6 h-6 text-violet-400 mt-1" />
                            <div>
                              <p className="text-white font-medium">Smart Contracts Polygon</p>
                              <p className="text-slate-400 text-sm">Transacciones inmutables en blockchain europea</p>
                            </div>
                          </div>
                          
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            <Shield className="w-6 h-6 text-violet-400 mt-1" />
                            <div>
                              <p className="text-white font-medium">Estándares Europeos</p>
                              <p className="text-slate-400 text-sm">Cumplimiento GDPR, IDSA y regulación Data Act</p>
                            </div>
                          </div>
                        </div>
                      </div>
