...
const techCards = [
  {
    id: 'gaiax',
    title: 'GAIA-X',
    subtitle: 'Identidad Soberana',
    description: 'SSI (Self-Sovereign Identity) y Credenciales Verificables para control total de identidad digital.',
    icon: Shield,
  ...
  },
  {
    id: 'idsa',
    title: 'IDSA',
    subtitle: 'Conectores EDC',
    description: 'Eclipse Data Connector para intercambio seguro de datos B2B.',
    icon: Link2,
  ...
  },
  {
    id: 'pontusx',
    title: 'Pontus-X',
    subtitle: 'Blockchain Europea',
    description: 'Notarización inmutable en Polygon con soporte EUROe.',
    icon: Network,
  ...
  },
  {
    ...
    subtitle: 'Integración Nativa',
    description: 'SAP, Oracle, Microsoft Dynamics - Sincronización bidireccional.',
    icon: Database,
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Stack Tecnológico <span className="text-cyan-400">Certificado</span>
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Infraestructura enterprise-grade basada en estándares europeos
          </p>
        </motion.div>
        ...
        >
          {[
            { icon: Key, label: 'Encriptación E2E', value: 'AES-256' },
            { icon: FileCheck, label: 'Certificación', value: 'ISO 27001' },
            { icon: Server, label: 'Hosting', value: 'EU-only' },
            { icon: Shield, label: 'Compliance', value: 'GDPR' },
          ].map((item, i) => (
            <div 
              key={i}
