...
import { generateTelenaturaDocTecnicoPDF } from "@/utils/generateTelenaturaDocTecnicoPDF";
import {
  DocTecnicoHero,
  DocResumenEjecutivo,
  DocPropiedadDatos,
...
const TelenaturaDocTecnico = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    setTimeout(() => {
      generateTelenaturaDocTecnicoPDF();
                    ...
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                        activeSection === section.id
                          ? "bg-[hsl(var(--telenatura-green)/0.1)] text-[hsl(var(--telenatura-green))] font-medium"
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full bg-[hsl(var(--telenatura-green))] text-white shadow-lg hover:bg-[hsl(var(--telenatura-green)/0.9)] transition-colors flex items-center justify-center"
          >
